...
| Live Demo                                                    | Thumbnail                                                                                                       |          Category           |                    Java file                     |                   Repository                    |                                           WebFX library                                            |                                                        Credits                                                        |
|--------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|:---------------------------:|:------------------------------------------------:|:-----------------------------------------------:|:--------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------:|
| Website                                                      |                                                                                                                 |                             |                                                  |                                                 |                                                                                                    |                                                                                                                       |
...
| [DemoFX][webfx-demofx-demo-link] ⓒ ♪                         | [DemoFX](https://user-images.githubusercontent.com/15129227/193560728-bbd5e954-a530-475e-9535-fb981345b0a5.mov) |          Animation          |      [Java file][webfx-demofx-code-link] ⭐       |      [Repository][webfx-demofx-repo-link]       |                                     [DemoFX][webfx-lib-demofx]                                     |                                             [Chris Newland][demofx-repo]                                              |
...
| [DemoFX Kitchen Sink][webfx-demofxkitchensink-demo-link] ⓒ ♪ |                                                                                                                 |          Animation          | [Java file][webfx-demofxkitchensink-code-link] ⭐ | [Repository][webfx-demofxkitchensink-repo-link] |                                     [DemoFX][webfx-lib-demofx]                                     |                                             [Chris Newland][demofx-repo]                                              | |
| WebFX Extras                                                 |                                                                                                                 |                             |                                                  |                                                 |                                                                                                    |                                                                                                                       |
...
[webfx-demofxkitchensink-demo-link]: https://demofxkitchensink.webfx.dev
[webfx-demofxkitchensink-repo-link]: https://github.com/webfx-demos/webfx-demo-demofxkitchensink
[webfx-demofxkitchensink-code-link]: https://github.com/webfx-demos/webfx-demo-demofxkitchensink/blob/main/webfx-demo-demofxkitchensink-application/src/main/java/dev/webfx/demo/demofxkitchensink/DemoFXKitchenSinkApplication.java
