...
| Browser link                                                   |          Category           |                                                                          Java file                                                                           |                               Repository                               |                                                     WebFX library                                                      |                                                        Credits                                                        |
|----------------------------------------------------------------|:---------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------:|
| [Meteo](https://meteo.webfx.dev) ♪                             |      Weather forecast       |     [Java file](https://github.com/CommonGrounds/Meteo_WebFX/blob/main/Meteo_WebFX-application/src/main/java/com/java4now/meteo_webfx/Meteo_WebFX.java)      |       [Repository](https://github.com/CommonGrounds/Meteo_WebFX)       | [WebFX&nbsp;Stack][webfx-stack-link] [WebFX&nbsp;Extras][webfx-extras-link] [WebFX&nbsp;Platform][webfx-platform-link] |                                   [CommonGrounds](https://github.com/CommonGrounds)                                   |
...
[webfx-platform-link]: https://github.com/webfx-project/webfx-platform
[webfx-extras-link]: https://github.com/webfx-project/webfx-extras
[webfx-stack-link]: https://github.com/webfx-project/webfx-stack
